...
class FfvvAdminView extends StatefulWidget {
  @override
  _FfvvAdminViewState createState() => _FfvvAdminViewState();
}

class _FfvvAdminViewState extends State<FfvvAdminView> {
  ...
  void dismissItem(
    ...
    try {
      ...
      final result = await _ffvvUseCase.deleteFfvvDB(index);
